# https://alpha.bcause.app/discuss/debate/-MtiBM3ZeSt2Md-JdMoU
EXAMPLE_DEBATE_1 = """LucasB: This would have severe positive environmental advantages.Page Jimmy: All the environment benefits can be achieved just by a vegetarian diet, you don't have to go fully vegan
.Plant Robert: Only vegetarian would be good for earth is just a myth. You either go fully vegan or you are just kidding yourself.Kirk Hammet: Agree, think of CO2 emissions saved because of less caddle.Kirk Hammet: also, less caddle means less incentives for deforestation
.LucasB: Enforcing what to eat to people is against principle of freedom - even if we talk about dietary options.Kirk Hammet: Veganism is a choice, it should not be forced - especially to children
.Kirk Hammet: If we raise our children with the same values like our generation did, then we are just fuelling the same viscous circle that destroys our planet.LucasB: This would be much more ethical .Plant Robert: Vegan way of eating and living is the only sustainable (for our planet) lifestyle .Kirk Hammet: this is extreme. I am sure we - as a humanity - can find a way to keep living in this planet while enjoying every once in a while a good steak.Kirk Hammet: Veganism, while more ethical, good for the environment, and healthier diet, is not feasible for a great proportion of the human population.LucasB: Agree, in terms of cost, is an extremely -therefore not sustainable- expensive lifestyle. Only applicable to western societies"""

# https://alpha.bcause.app/discuss/debate/-M_1YNLl74hj1-KvS_vL
EXAMPLE_DEBATE_2 = """Ellen Jacobson: It may be technically possible to reverse climate change but is getting harder year by year.Lucas White: We cannot invest trillions in an attempt to reverse climate change, without first knowing that is possible, manageable and achievable in a reasonable amount of time.UserX: If governments around the world treat climate change collectively - the same way they treated World War 2 for instance - then is possible, no matter the cost.UserX: Every year that passes we lose tools or opportiunities that could work to counteract climate change as well as more damage is added - therefore is -unfortunately- irrevrsible.UserX: It is getter harder year by year by still possible.UserX: yes I go with the statement saying If governments around the world treat climate change collectively - the same way they treated World War 2 for instance - then is possible, no matter the cost.UserX: We need to take immediate steps and put a full stop on organisation who are playing with our future just for a quick buck.UserX: While I agree that it is getting harder every year, we need to do something about it now. It's never going to be an easy process, but the sooner we start, the better. We need to make drastic changes now so that policy and consumer interaction can be at the level necessary to move things in the correct direction. .UserX: It may be difficult, but the long run cost of doing nothing will certainly outweigh the costs of doing something. The sooner we act the better our chances of making a real difference.UserX: Many technologies like electric vehicles still plug into the grid and use fossil fuels. We do not have a zero emission grid yet.UserX: I agree that it can be very challenging. But what good is it to just give up. We have to at least try to make change, no matter how hard it can be. We just have to learn how to make the right types of changes. .UserX: I agree that we have to try. There is no quitting. .UserX: I agree that the sooner we act the better. Every day climate change grows.UserX: Even if it is getting harder we have to at least try.UserX: I agree. What does it help to not even try to change the advancement of climate change?.UserX: We're already experiencing an economic crisis. We can't just keep investing in preventing climate change. We have other priorities.UserX: Obviously it is getting harder. Each year more damage is done and we cannot deny the inevitable.UserX: I believe that too much damage has already been done by governments around the world especially due to geoengineering tactics that have already caused harm that cannot be reversed.UserX: But is it even possible to fix now or is it too far gone?.UserX: This is very true, but then isn't it time to start before it gets to be a worse situation? The economic impacts are starting to hit now. 
.UserX: What is more important than preventing climate change? Economic crisis? Your world is dying, we are dooming future generations with our actions and you have other priorities?.UserX: If we try to make a serious attempt we can definitely reverse the harmful effects.UserX: It is not possible to technically change the climate problem .UserX: You are right. The problem is slowly growing which is why we need to take steps to address it now. .UserX: I totattluy disagree because.Perry Padberg: Climate change is accelerating - due to feedback loops- much faster that what humanity can -or is willing to- decelerate it. Unfortunately is not feasible with current technology.Ellen Jacobson: If we identify the negative feedback loops and break them, then we have a chance of slowing or even reversing climate change.a Luca: Policy makers have vested interests with industry to ignore signals of overshoot and straining risks. Whatever action will be taken too late and there is no way to prevent feedback loops.Neal Kulas: I agree is a matter of political will above everything else.UserX: We can only do the best we can with the technology we have right now.UserX: Technology can not correct this problem unless u can grow more trees as quick as possible using technology.UserX: Technology can help but isn't the ultimate solution. We need to reduce overall consumption.UserX: Technology can help in sharing the importance to many people in less time  .UserX: Technology is ever changing. Maybe what we currently have cannot make lasting change, but it can make a change in the right direction. As technology updates, we can do more. I think it's more of an issue of becoming willing. .UserX: YES .UserX: of course the feedback loops will contribute but the question is how much.UserX: True, we need to increase technology to deal with this problem. .UserX: but how fast is it progressing and can we slow it enough to even make a difference?.UserX: I'm not sure the answers to those questions but if more of us put pressure on policy makers to invest funds into scientific studies it would give us a greater idea, but no one seems to care or want to spend any money to improve understanding of the issue.UserX: Because people are flawed and invested in themselves first, it is hard to get cooperation from all sides to do something about a polarizing thing like climate.UserX: What do you consider the feedback loops, first we have to list them. .UserX: It is happening due to some natural causes too. Technology can't stop the natural course of things.UserX: I agree that if governments are not willing to inform the public and stop manipulating us by placing chemical in the air for solar engineering than how do they expect individuals to comply.UserX: I agree. too  much damage has already been done to reverse the process and many people are unwilling to make changes to their lives that may be too much for their budget to handle.UserX: Technology changes every day. Things are possible today that were unheard of just a few years ago. Who knows what could be possible in a few years, given enough inventiveness and creativity. It's not about "current" technology; it's about future technology -- the very near future.Perry Padberg: Human resources and efforts are best used adapting to the effects of climate change, rather than attempting to mitigate climate change itself.Lucas White: Adaptation and fighting climate change often go hand in hand.UserX: I agree I think we should adapt the best we can. We can't change what has already happened.UserX: I think we can fight climate change I don't think it is too late yet.UserX: We cannot adopt but we should adopt to it because there is no other go with the affected environment unless helping the environment  less pollution.UserX: Since most of the climate change is caused by big organisations, I dont think just adapting to climate change is the right thing to say. There is a lot that is out of our hands.UserX: I agree that we, as humans, can adapt to the situation as best as possible. But we can also take small steps towards change. The situation doesn't have to be impossible. .UserX: We do have to adapt and evolve with the shifting climate. It's too late to halt the process entirely.UserX: Humans have very little effect on what can be done to eradicate such a large problem. Yes every little bit helps, but how can the poor people afford to pay the extra for environmentally safe products, etc such as electric cars.UserX: Human efforts include planting trees and reduction of pollutants in the environment.UserX: that's because most think there is no use, that it is hopeless.UserX: Adaptation is not giving up and I agree that effort made to do this is a good idea. The more people think about this, the more likely they are to achieve changes without even realizing they are doing it. Adaptation doesn't mean we are giving up on the environment. It means we are not stressing so hard over the guilt of what we perceive we have done to damage the earth.Tyler Dickinson: We can only achieve by tremendous advances and investment in technology: clean energy production, CO2 capture in massive scale, hydrogen planes, ... , and much much more  .UserX: I dont mind this but we cant ignore the fact that there are company who are spreading so much pollution and greenhouse effect just for profit. We need to reprimand them as well.UserX: Technology is not our savior. We need to reduce overall consumption and adopt more sustainable practices on a massive scale.UserX: Efforts needs to be taken care.UserX: It seems that massive industrial scale projects are what caused climate change. Large scale industry is a major cause of pollution.UserX: Imagine the benefit to humanity all this new science could achieve!.UserX: I don't think these are all realistic goals. .UserX: CO2 reaches historic levels everyday.When it is control the climate change returned normal condition.Unless future will be in worst condition.UserX: That's a huge investment when we do have other issues in the world to deal with first.UserX: We don't have the resources to do this. It is completely unreasonable.UserX: The thing here is, if we don't do it, then there's nothing we have to look forward to. Anything else will be null and void without a planet to live on. .UserX: Yes the costs are very high and most technologies in the [past have failed such as wind turbines etc which need electricity which cancels the effort.UserX: But who is going to pay for all thee changes? Big business surely will not foot the bill and pour own government in the USA is in so much debt already that we are nearing an economic collapse.UserX: These investments don't all have to be a negative thing - they can lead to massive job growth and prosperity, if designed and implemented correctly. 
.UserX: Already we are ruin the nature to observe the CO2 and other gases.Now we are expecting the solution in technology side.It is not fully solution for change the climate.So we want to focus the nature resources management.
.UserX: i agree. it is going to take some major technology advances to tackle the problem.UserX: The nature itself correct the human inflicted changes and balance the climate. But the human should bear the losses in this process.UserX: Human spoiled the nature to a great extent and they have to face the consequences and should avoid doing more harm to the environment any further.UserX: Technology can not correct this problem unless u can grow more trees as quick as possible using technology.UserX: absolutely true growing more trees are the only solution to this problem
 .UserX: I agree. We already have lumber shortages as it is and this will only get worse as time goes on unless we do something. Deforestation has caused a lot of issues and reversing that could go a long way in helping to stabilize the climate once again. .UserX: Technology can help. Planting trees can also help but isn't the single solution. We need to simultaneously adopt many strategies and methods to fight climate change. .UserX: Human spoiled the nature to a great extent and they have to face the consequences and should avoid doing more harm to the environment any further.
.A L: I am sorry but NO. Almost the whole human civilisation runs of fossil fuels pumped from the deep carbon cycle to the fast carbon cycle. It will reverse naturally over several million years, not the short-term which we can benefit from right now.UserX: I think we have to look into alternatives fuels and see how we can cut down on the consumption. The main onus is on big organisations since they are major defaulters.UserX: I agree with this. With that being said, we as consumers need to demand more from the same organizations. We need to go to all levels of government and demand that these same organizations give us alternatives in the form of electric and hydro cars while also proving that we are ready to purchase them to give these same organizations incentive to play along.  .UserX: I completely agree with this. There are multiple exposes and car engineering shows were independent organizations show not only that we can reduce carbon emissions, but that we can also run cars way more efficiently with our current fossil fuels. If people demand the same level of efficiency with future fossil fuel using vehicles we can begin to make real changes. This will in turn give us the time necessary to begin building the infrastructure necessary for those alternative fuel sources as we will need to build electric gas stations and charge stations around the country before demanding an increase in those alternative vehicles from organizations. .UserX: Companies strategically and purposely try to shift the blame and responsibility onto individual consumers. We need regulations and government intervention to force change on a larger scale, or companies will continue to irreparably damage the environment for short term profits.UserX: We cannot adopt but we should adopt to it because there is no other go with the affected environment unless helping the environment  less pollution
.UserX: we need to adopt to the current situation , we should not deny that we are responsible for all the problem that we create in accordance with situation .UserX: electric vehicles should be consider as mandatory by the major fuel consumption nations
.UserX: While I agree, there are a lot of things that have to happen first before this can become a reality. We have to rework gas stations around the country so that they have the charging stations necessary for electric vehicles and we have to build the charging stations near highways and thoroughfares for those same electric cars so that the future infrastructure is ready to handle the influx of electric cars before demanding they be manufactured at such a high rate. .A L: I am sorry but NO. Almost the whole human civilisation runs of fossil fuels pumped from the deep carbon cycle to the fast carbon cycle. It will reverse naturally over several million years, not the short-term which we can benefit from right now.BB LL: Conservation of resources may end up where it's eventually undone by someone who takes them, as nature doesnt like a void.So climate change can be neutral at best and getting worse at worst with this principle.UserX: yes I go with the statement saying If governments around the world treat climate change collectively - the same way they treated World War 2 for instance - then is possible, no matter the cost.BB AA: Some damage towards the climate is currently irreversible to prevent reversal in time.WW QQ: By our actions many species have been made extinct and the chemistry of the gasses that make up our atmosphere have been altered.Climate change caused extinctions are permanent, it follows therefore we cannot wind back the clock.A Lucas: Even though damage is done, there are ways to counter the damage through other actions. If enough of these are done, they can cumulatively overpower the irreversible actions and thus reduce climate change as a net overall.A L: Technology may increase to where it can be - like developing time travel.UserX: The fact is that the knowledge on climate change is still very limited. Assumptions that we make about the damage today could be disproved tomorrow. Take for example the holes in the Ozone. We discovered them with advances in technology, but no one is really sure that we caused them or even for how long they had actually been there. With advancements in technology there is little reason to believe we can't reverse some of these things. .UserX: This may be true to an extent, but it isn't a reason to give up on making positive change to create a better future.UserX: I do believe that climate change is an issue but we need to put the blame to big organisations and put the onus on them to reverse it.UserX: Climate Change is the main issue 
It causes a lot damage to our environment 
Thanks to some of the volunteers who are helping to fix the issue by sharing the issues in mass media to cover up a lot of people .BB LL: Maybe. But all humanity should collectively act together with the lead of the big super powers. If USA and China stay out, I am afraid it would be useless.BB AA: Agree, the biggest contributors of CO2 emissions (USA and China) should do the most effort to reverse this.WW QQ: This should be part of every single citizen mendality in this planet. Assuming that this is a problem of someone else, then we will lose the fight before it even starts! .A Lucas: Climate change is anyways is a hoax! 31,000 scientists reject global warming and say "no convincing evidence" that humans can or will cause global warming.UserX: Correct , but technology is the need of today's humanity  but it should also help the nature side by side .UserX: Correct ,technology is the need of today's humanity  but it should also help the nature side by side .UserX: If you are ready to harm the nature by using technology  then get ready to find a solution or alternative to nature if possible to protect the climate and environment. .BB AA: Statistics and trends are showing that climate change is irreversible(https: //www.npr.org/templates/story/story.php?storyId=99888903&t=1621870823276).WW QQ: With entropy, all efforts to restore the atmospheric gas balance will still leave a lot of the changes to the worldfor a very long time.Mitigation might be all we can do at this point,rather than being able to fully reverse it.A Lucas: Physicist Stephen Hawkings  warns that we are close to the tipping point, but climate change can be reversed if the human race acts now.A L: Greenhouse gases were drastically higher when the dinosaurs walked, and earth survived just fine. Climate change can always be reversed, the question is simply how much effort over what period of time.UserX: Today the growing population is struggling to live with the available resources as it is not sufficient to meet the demands of the people , so they have to interfere with the nature and exploiting it . You can say they are using more and more chemical in agriculture to grow more and fast which is not at all good for the human ultimately and to the nature.BB LL: We are simply not prepared to give up on our modern lifestyle to achieve this. Nobody wants to give up his cheap flight to exotic destinations, his big petrol car, cheap electricity, ...  .BB AA: Human populations are approaching carrying capacity on planet Earth. The scientific community thinks this is a number on the order of 9 to 10 billion people. Without population control, there can be no effective solution for reversing the effects of human-induced climate change.WW QQ: There is a spread of policies that come under the heading of population control ranging from the coercive to the persuasive.UserX: Population is the main cause 
Increase in Population spoils the country 
Lifestyle also needs to be changed according to the nature .WW QQ: I am sorry but NO. Almost the whole human civilisation runs of fossil fuels pumped from the deep carbon cycle to the fast carbon cycle. It will reverse naturally over several million years, not the short-term which we can benefit from right now.BB LL: We are simply not prepared to give up on our modern lifestyle to achieve this. Nobody wants to give up his cheap flight to exotic destinations, his big petrol car, cheap electricity, ...  .BB AA: Human populations are approaching carrying capacity on planet Earth. The scientific community thinks this is a number on the order of 9 to 10 billion people. Without population control, there can be no effective solution for reversing the effects of human-induced climate change.WW QQ: There is a spread of policies that come under the heading of population control ranging from the coercive to the persuasive.A Lucas: Conservation of resources may end up where it's eventually undone by someone who takes them, as nature doesnt like a void.So climate change can be neutral at best and getting worse at worst with this principle.A L: Some damage towards the climate is currently irreversible to prevent reversal in time.BB LL: By our actions many species have been made extinct and the chemistry of the gasses that make up our atmosphere have been altered.Climate change caused extinctions are permanent, it follows therefore we cannot wind back the clock.BB AA: Even though damage is done, there are ways to counter the damage through other actions. If enough of these are done, they can cumulatively overpower the irreversible actions and thus reduce climate change as a net overall.WW QQ: Technology may increase to where it can be - like developing time travel.UserX: I like this becuase
.UserX: one con is this one.UserX: Another con is this one.WW QQ: I am sorry but NO. Almost the whole human civilisation runs of fossil fuels pumped from the deep carbon cycle to the fast carbon cycle. It will reverse naturally over several million years, not the short-term which we can benefit from right now.A L: Some damage towards the climate is currently irreversible to prevent reversal in time.BB LL: By our actions many species have been made extinct and the chemistry of the gasses that make up our atmosphere have been altered.Climate change caused extinctions are permanent, it follows therefore we cannot wind back the clock.BB AA: Even though damage is done, there are ways to counter the damage through other actions. If enough of these are done, they can cumulatively overpower the irreversible actions and thus reduce climate change as a net overall.WW QQ: Technology may increase to where it can be - like developing time travel.BB AA: Sustainable efforts reduce and reverse the global warming trend.WW QQ: Educating people (such as making it mandatory in the school system) on how to reverse climate change can give people the option to make positive changes to the situation.A Lucas: All we can do is reduce our impact but not reverse it.Unfortunately is statistically inevitable .BB LL: Human populations are approaching carrying capacity on planet Earth. The scientific community thinks this is a number on the order of 9 to 10 billion people. Without population control, there can be no effective solution for reversing the effects of human-induced climate change.BB AA: There is a spread of policies that come under the heading of population control ranging from the coercive to the persuasive.UserX: Conservation of resources may end up where it's eventually undone by someone who takes them, as nature doesnt like a void.So climate change can be neutral at best and getting worse at worst with this principle.
.BB AA: I am sorry but NO. Almost the whole human civilisation runs of fossil fuels pumped from the deep carbon cycle to the fast carbon cycle. It will reverse naturally over several million years, not the short-term which we can benefit from right now.UserX: yes I go with the statement saying If governments around the world treat climate change collectively - the same way they treated World War 2 for instance - then is possible, no matter the cost
.A L: Statistics and trends are showing that climate change is irreversible(https: //www.npr.org/templates/story/story.php?storyId=99888903&t=1621870823276).BB LL: With entropy, all efforts to restore the atmospheric gas balance will still leave a lot of the changes to the worldfor a very long time.Mitigation might be all we can do at this point,rather than being able to fully reverse it.BB AA: Physicist Stephen Hawkings  warns that we are close to the tipping point, but climate change can be reversed if the human race acts now.WW QQ: Greenhouse gases were drastically higher when the dinosaurs walked, and earth survived just fine. Climate change can always be reversed, the question is simply how much effort over what period of time.UserX: Climate change is anyways is a hoax! 31,000 scientists reject global warming and say "no convincing evidence" that humans can or will cause global warming.A L: Human populations are approaching carrying capacity on planet Earth. The scientific community thinks this is a number on the order of 9 to 10 billion people. Without population control, there can be no effective solution for reversing the effects of human-induced climate change.BB LL: There is a spread of policies that come under the heading of population control ranging from the coercive to the persuasive.WW QQ: Maybe. But all humanity should collectively act together with the lead of the big super powers. If USA and China stay out, I am afraid it would be useless.A Lucas: Agree, the biggest contributors of CO2 emissions (USA and China) should do the most effort to reverse this.A L: This should be part of every single citizen mendality in this planet. Assuming that this is a problem of someone else, then we will lose the fight before it even starts! .UserX: Adaptation and fighting climate change often go hand in hand
.UserX: i agreed it. because this is only by our hand to protect our planet from this climate change issue. so we have to should use green energy sources only in future.UserX: pro.Anna: cons.Anna: pro 1.A Lucas: Human populations are approaching carrying capacity on planet Earth. The scientific community thinks this is a number on the order of 9 to 10 billion people. Without population control, there can be no effective solution for reversing the effects of human-induced climate change.A L: There is a spread of policies that come under the heading of population control ranging from the coercive to the persuasive.UserX: we have alternate way to think this problem. human population control is may be possible one way. but other way we have to follow and find alternate solution for this climate change problems like find reusable energy sources and green sources. mainly control co2 pollution through vehicles. .UserX: There are a lot of moral issues to consider when talking about things like population control. Issues like these have been in public policy for decades without a solution.UserX: Population experts expect that the world's population will plateau in several decades without any coercion. Educating people about effective means of birth control and social responsibility could have some effect of speeding the leveling of the population sooner. There doesn't seem to be the need for drastic measures. .UserX: Human resources and efforts are best used adapting to the effects of climate change, rather than attempting to mitigate climate change itself.
.UserX: I don't think that we should choose either mitigation or adaptation. It seems that both are very useful tools to fight climate change and other environmental concerns.UserX: I don't think that simply mitigating the problem should be our focus. .UserX: As by this planet every year human population increased by year by year. so that human needs also may increased. we have to find another solution for this climate change else we have to find alternate reusable energy sources like green gas, electric bike etc. this is the only way to protect our planet from this climate chagne.WW QQ: Some damage towards the climate is currently irreversible to prevent reversal in time.A Lucas: By our actions many species have been made extinct and the chemistry of the gasses that make up our atmosphere have been altered.Climate change caused extinctions are permanent, it follows therefore we cannot wind back the clock.A L: Even though damage is done, there are ways to counter the damage through other actions. If enough of these are done, they can cumulatively overpower the irreversible actions and thus reduce climate change as a net overall.BB LL: Technology may increase to where it can be - like developing time travel.UserX: There are certain steps we can take to help with climate change. Just sitting back sayin that nothing can be done isn't helping anything. We need to step up and take steps toward improving the situation. .UserX: Climate change science is inconclusive. .UserX: I do agree. I do believe there is some impact on climate due to man's activity but this has been studied over such a short term that I am skeptical of any hard and definite conclusion.UserX: Imagine how terrible we all would feel if we made the planet cleaner for everyone only to find out it was a hoax?.UserX: I agreee.UserX: I disagree.UserX: I disagree but I still overall would do this.A L: I am sorry but NO. Almost the whole human civilisation runs of fossil fuels pumped from the deep carbon cycle to the fast carbon cycle. It will reverse naturally over several million years, not the short-term which we can benefit from right now.UserX: I'm pro taking action. It doesn't have to be a big action, but if we all play our parts, we can make even small changes to help offset the situation. .A L: Sustainable efforts reduce and reverse the global warming trend.BB LL: Educating people (such as making it mandatory in the school system) on how to reverse climate change can give people the option to make positive changes to the situation.BB AA: All we can do is reduce our impact but not reverse it.Unfortunately is statistically inevitable .BB LL: Climate change is anyways is a hoax! 31,000 scientists reject global warming and say "no convincing evidence" that humans can or will cause global warming.UserX: This an argument that I agree with. I do not believe there is a consensus and I have little confidence in the "science" that supports man's heavy influence on climate change. I believe a lot is hysteria used to socially engineer behavior. I also believe a lot of hubris and ego has contributed to this doomsday theory. The leftist talking point last year was we have only 12 years left before we are all dead due to climate change. That is utter nonsense.UserX: I gree because.BB LL: Conservation of resources may end up where it's eventually undone by someone who takes them, as nature doesnt like a void.So climate change can be neutral at best and getting worse at worst with this principle.BB AA: Maybe. But all humanity should collectively act together with the lead of the big super powers. If USA and China stay out, I am afraid it would be useless.WW QQ: Agree, the biggest contributors of CO2 emissions (USA and China) should do the most effort to reverse this.A Lucas: This should be part of every single citizen mendality in this planet. Assuming that this is a problem of someone else, then we will lose the fight before it even starts! .BB AA: Some damage towards the climate is currently irreversible to prevent reversal in time.WW QQ: By our actions many species have been made extinct and the chemistry of the gasses that make up our atmosphere have been altered.Climate change caused extinctions are permanent, it follows therefore we cannot wind back the clock.A Lucas: Even though damage is done, there are ways to counter the damage through other actions. If enough of these are done, they can cumulatively overpower the irreversible actions and thus reduce climate change as a net overall.A L: Technology may increase to where it can be - like developing time travel.UserX: For some people, "Man made climate change" begs the question. While I might not be one of them, I'll say assuming climate change is indeed man made, all we can do is reduce our greenhouse gas generation. This will require the shift from fossil fuels to renewable energy sources to be prioritized more than it currently is. .UserX: I think it is possible to reverse climate change, if we do reverse our consumption habits. Though it will take time. .UserX: It should be taught to children to make the world cleaner and safer for all animals.A L: I am sorry but NO. Almost the whole human civilisation runs of fossil fuels pumped from the deep carbon cycle to the fast carbon cycle. It will reverse naturally over several million years, not the short-term which we can benefit from right now.UserX: If carbon dioxide emissions were to decrease, the absorption of carbon dioxide by plant life and through the oceans would remain the same. I think millions of years is a very pessimistic estimate. Our planet tends to balance itself out within a shorter time frame.
.UserX: I agree it is going to need a world effort to combat climate change. Not just a few rich countries trying to.
.UserX: Countries still catching up to the industrial revolution will argue it unfair.UserX: Also, it is always better to do something than nothing, and then regretting it. .A Lucas: I am sorry but NO. Almost the whole human civilisation runs of fossil fuels pumped from the deep carbon cycle to the fast carbon cycle. It will reverse naturally over several million years, not the short-term which we can benefit from right now.A L: Conservation of resources may end up where it's eventually undone by someone who takes them, as nature doesnt like a void.So climate change can be neutral at best and getting worse at worst with this principle.BB LL: Some damage towards the climate is currently irreversible to prevent reversal in time.BB AA: By our actions many species have been made extinct and the chemistry of the gasses that make up our atmosphere have been altered.Climate change caused extinctions are permanent, it follows therefore we cannot wind back the clock.WW QQ: Even though damage is done, there are ways to counter the damage through other actions. If enough of these are done, they can cumulatively overpower the irreversible actions and thus reduce climate change as a net overall.A Lucas: Technology may increase to where it can be - like developing time travel.UserX: I am skeptical of man-made climate change. To answer the prompt I would say yes, it is possible to balance it out. I am not sure what reversing it means. Our planet adapts to climate changes over time. It always has. During the time of the dinosaurs the amount of carbon dioxide and oxygen in the atmosphere was greater than it is today. Earth's climate will always change. Mother nature has the ability to adapt. .UserX: The newest "science" related to this topic now questions how additional greenhouses in our atmosphere truly effects atmospheric and climate change. It looks to be that additional carbon dioxide does not have as dramatic an effect on temperature as previously purposed. This is cause to re-question what actually would need to be reversed and how much influence our consumption of fossil fuels actually has on global climate.  .A Lucas: Climate change is anyways is a hoax! 31,000 scientists reject global warming and say "no convincing evidence" that humans can or will cause global warming.UserX: I agree it is going to need a world effort to control the climate change and also we need to use classic technologies like cycle and public transports . If we don't do it we are suffers lot. surly human cause the global warming the large countries and humans need aware of it. bio gas and low carbon released vehicles most electric and solar vehicles are best.
 .UserX: we need alternative technology also population control. large population need large resources.its bad. we need alternative and new technologies.BB AA: Human populations are approaching carrying capacity on planet Earth. The scientific community thinks this is a number on the order of 9 to 10 billion people. Without population control, there can be no effective solution for reversing the effects of human-induced climate change.WW QQ: There is a spread of policies that come under the heading of population control ranging from the coercive to the persuasive.UserX: climate change is very important issue. we are need more awareness about it. we need to reduce, every one is important to take action.we choice alternative to control like bio gas, electric and solar like.UserX: No. sorry i not accept Climate change is not a hoax. we also feel in real life. we need more awarness.UserX: Whether or not it is a hoax, human having rational thinking he have the guilty when he affect the environment with pollution like fumes, industrial wastes and other things damaging the society.Rachael Walsh: I feel that climate change is happening on some level, but question how much of it is due to a natural cycle and how much to human activity.    When it comes to stopping pollution and protecting the earth, I am on board.   Where I draw the line is using climate change as a platform to implement socialist policies and take excessive freedoms from people.Rachael Walsh: If people can start separating strategies to help the earth and politics, I would be more apt to believe it.   An example is the new green deal that is being proposed in the US.  When you read it, a majority is about socialist policies and overreach of the government and is not relevant in anyway to climate change.  Other agreements let large polluters like China and India off the hook while expecting a disproportionate amount from the US.   This makes me very cynical about the overall agenda behind it.UserX: Whether or not it is a hoax, human having rational thinking he have the guilty when he affect the environment with pollution like fumes, industrial wastes and other things damaging the society.
.UserX: Hope the lock down because of corona must have proved that the environment is less polluted when people stop coming out of their home. But it is not possible to stay at home completely. But it is a evidence that human is polluting the economy. so they can reduce the pollution by way of using electric vehicles, cycling and other ways.UserX: Government should impose some rules on the people to protect the environment . It may say every one must use electric vehicles, every home must have minimum no of trees grown to counteract the man made damage.UserX: And the Govt must give rewards to those who do activities to protect the environment.UserX: I tend to think that the government subsidizes too much already .UserX: I think the idea of the government rewarding people who participate in activities to protect the environment is a very good idea. It would encourage people to do that more.UserX: I think reversing manmade climate change would be very difficult. Scientists might come up with solutions to attempt it, but I don't think it can be totally reversed.UserX: I agree with you. I don't know that there is a good solution. .UserX: I agree that it will get harder every year to address climate change. The worse it gets, the more of a challenge it will be to address it.UserX: I think the best thing for people to right now is to reduce or eliminate their consumption of products that contribute to climate change. That way even if there is not a solution to totally reverse it, at least it will not progress as fast.UserX: Its not a easy thing to inconvenience people more than they already are.UserX: I f we reduce usage of contaminating earth stuff eventually the earth will heal itself. The earth is a wonderous thing. Now the problem eventually will not be whether the earth can recover it will be if humans can survive in the toxic atmosphere created by humans. The earth will be here a long time its life that will become extinct. Focus more on not what will happen to the earth but what will happen to life on earth.UserX: Think about it life has not been on earth as we know for a very long time, maybe 50- 60 thousand years. The earth has been around for what a trillion years. So what will go first. Lets call it what it is, not attempt to save the earth but to save life on earth. I am pretty sure the earth will be here long after life has been erased from its surface. .UserX: Well said, its been here this long, I think its safe to assume it will stay that way for a long time.UserX: Climate change will never be reversible, humans are humans and far to many either do not believe it is happenings or cannot find the time to do any thing about it. As it goes now life on earth will be in jeopardy before my grand kids get to be my age.UserX: How are we in jeopardy? The earth has made it this long, it will continue that way.UserX: Governments do not want to give up control of what makes them rich and fossil fuels make many governments trillions of dollars. If you think they will give up this cash in favor of climate control you are sadly mistaken. As long as money means power we are doomed AND THE POOR WILL BE THE FIRST TO SUFFER.UserX: Im not sure what the poor has to do with it.UserX: By letting the earth heal itself and be left alone. The earth has made it this long and I assume and really think it will make it long after we are gone. There are probably some small things we can do here and there, but for the most part the earth can take care of itself.UserX: If you believe that its man made and that man caused it, then its possible and likely that man can fix it like anything else. I guess part of the solution is figuring out a way thats not going to bankrupt us and is reasonable.UserX: With the increase of humans on our planet, we need to understand resources are finite and adapt.UserX: We should work to stop polluting the planet just for this sake alone. Who doesn't want a cleaner planet? .UserX: To keep the refrigerant management and forest restoration helps to change the climate.It could take a very long period of time but coming decades are survive easily.UserX: We can only achieve by tremendous advances and investment in technology: clean energy production, CO2 capture in massive scale, hydrogen planes, ... , and much much more
.UserX: how can we get all countries on board with this?.UserX: If we identify the negative feedback loops and break them, then we have a chance of slowing or even reversing climate change.UserX: Seems to involved and complicated for most to even want to try. .UserX: governments and corporations wont want to spend the money to put in the research for this.UserX: We can only achieve by tremendous advances and investment in technology: clean energy production, CO2 capture in massive scale, hydrogen planes, ... , and much much more
.UserX: To keep the refrigerant management and forest restoration helps to change the climate.It could take a very long period of time but coming decades are survive easily.
.UserX: We can only achieve by tremendous advances and investment in technology: clean energy production, CO2 capture in massive scale, hydrogen planes, ... , and much much more.UserX: In a facilitated discussion, the facilitator assists the parties to prepare for and engage in a conversation around the issues that are causing conflict. A facilitator will assist each party individually to: Identify the issues that are at stake; ... Prepare to have a conversation with the other person about the issues.
.UserX: Policy makers have vested interests with industry to ignore signals of overshoot and straining risks. Whatever action will be taken too late and there is no way to prevent feedback loops.UserX: As citizens we can put pressure on our elected policy makers to put their time, money, and funding into this cause. .UserX: Policy makers have vested interests with industry to ignore signals of overshoot and straining risks. Whatever action will be taken too late and there is no way to prevent feedback loops
.UserX: there are ways to hold them accountable if we could get people to pay enough attention and apply political pressure for them  to act.UserX: If we identify the negative feedback loops and break them, then we have a chance of slowing or even reversing climate change.UserX: Presentation: Have one or multiple members share their screen and give a short presentation, then open up to discussion. Share a challenge: Each person has a chance to share a challenge that they want feedback on and then gets time for other participants to give them feedback.UserX: To keep the refrigerant management and forest restoration helps to change the climate.It could take a very long period of time but coming decades are survive easily.
.UserX: Climate change is accelerating - due to feedback loops- much faster that what humanity can -or is willing to- decelerate it. Unfortunately is not feasible with current technology
.UserX: Human populations are approching carrying capacity on planet Earth.Without population control there can be no effective solution for reversing the effects of climate cange.
.UserX: I don't have a hard stance on this because I do not feel knowledgeable enough about the issue to say for sure what my ideal solution would be. I agree it is a gigantic problem that needs to be met with urgency and importance by all of us. I don't know that we could reverse climate change, it seems most damage has been done, but I'm hopeful taking stronger actions now would at least help reverse some things, and prevent current issues from developing further. It's worth trying.UserX: I think we all need to gather our communities and apply pressure on policy makers to address these issues with urgency
.UserX: The rising temperature causes all the problems .The human cause of climate change is not disputed by any scientific body.UserX: Scientists have been saying this many years now, it seems people just want to ignore the problems and hope it will go away on its own!
.UserX: Not all scientists input is put into the public eye and if a scientist is against the propaganda than they just eliminate him from being heard.UserX: There are many scientist who refute the "climate change scenario but are silenced and not allowed to speak their beliefs. They are classified as "conspiracy theorists".UserX: I totally agree with this. I don't understand how much more it will take before humans do something to make significant changes. We are often reactive instead of proactive but in this case our efforts will most likely be to late to significantly alter the course we are on. .UserX: I don't believe this really. There are scientists who definitely dispute that humans are a cause of climate change. They also cite many types of weather patterns that cycle over and over over thousands of years that are also part of the cause.UserX: There are two groups of people. one who want to save the ecology and another group who want to exploit the environment for making money. unless strict rules are passed to stop the abuse of nature we cant save the nature and the environment.UserX: Sadly many businesses just don't care and are all about making $$$$ and abusing the environment over helping take care of the current ecological crisis.UserX: I agree that big business is only interested in the profits they can make and not at all interested in the citizens and their welfare.UserX: I think there is another group that is probably more a majority than the two groups mentioned. That group is the people who do care about the environment but is overwhelmed by the sheer cost and magnitude of the many things they are told they should be doing while also trying to navigate their own lives. And when they don't scream vocally about saving everything, they get accused of being part of the exploiting group.UserX: There must be one day lock down for every month to maintain the pollution which we are experiencing through lock down for corona.UserX: This makes so much sense, and its not like it cannot be done. Many countries during the lockdown for Covid, showed they could easily have one day a month or such to have no pollution days where it would help the environment immensely.UserX: Lockdowns are not the answer to the problem. Look how the lockdowns for the virus have caused the economy to go downhill and the depression and bad effects on the people both socially and psychologically.UserX: Regularly scheduled mini lockdowns are a possible part of a solution. More ideas like these need to be formulated and multiple avenues have to be explored and implemented. It's not about one solution or one quick fix -- it's going to be about a number of different plans and programs working together to a unified solution made up of many segments.UserX: Yes, During this lockdown days, the earth seems to be very good. But one day is not enough.UserX: Countries need not to spend much for this. It must initiate some compulsory programs and stop producing vehicles that depends on petrol etc.UserX: But how the the average person avoid these companies big expensive ideas when they are just about making ends meet now?.UserX: Then what happens to those who cannot afford to buy new vehicles and what about all the oil producing companies and businesses that will be ruined?.UserX: That is true. Every country should take  adequate measures in preserving nature and environment.UserX: even electric cars are not great for the environment. .UserX: look into all that gas cars require before you are so quick to promote them. .UserX: Climate change is happening and speeding up as we go on. It should be the #1 priority for EVERYONE to find ways to resolve this. PERIOD.UserX: This should have been thought about many years ago. I believe things are too far gone to ever be able to get the planet back to normal again.UserX: I think there are bigger fish to fry at the moment. .UserX: This is the one problem that no one on this planet can run from. Your ignorance, your disbelief and even you money can only save you for so long. There is no coming back from making our planet nonviable for all living things.UserX: I think climate change is a problem, but has been brought about not by the average citizens of the world but by the governments and big corporations who control us. We are deceived and being lied to by global organizations such as the World Economic Forum who want to take over and control the planet.UserX: Absolutely right, we are in the hands of corporate business man. But we can change this situation by changing our lifestlyes.UserX: This conversation seems to be pointless as our opinions will probably never be heard by those who are in control and authority and by big government who controls the people. They are the ones that need to hear and listen to the  people through forums and discussions.UserX: The world is changing in terms of human empowerment and the connectedness of the individual and the transparency of the powers that be. The opinions of the people CAN be heard and change is possible. Humanity needs to work together and gain strength from one another. .UserX: I don't think that's true anymore - working in a large corporation, 5 years ago, we would have never talked about sustainability, been willing to pay more for anything sustainable, or frankly, really been concerned. Now, we have no real choice - consumers are simply demanding it. .UserX: This conversation helps us to think more regard this issue, we are learning more. Our conscience makes us alert and we will work for it. At least from our home.UserX: The worst thing we could do would be to continue to do nothing. That's what's gotten us into this mess in the first place. Technology is evolving rapidly; think of all the changes and advancements that have been made in the recent past. Perhaps a solution is around the corner and we just don't know what it is yet. We cannot give up.UserX: Placing blame and/or trying to figure out who's at fault is pointless. It doesn't matter if it's the corporations, individuals, or natural processes--the problem exists, whatever the cause. And it has to be addressed, even if it's expensive, even if it's monumental, even if it seems impossible to solve--because without working toward a solution, our planet and ourselves will cease to exist.UserX: If we don't ask corporations to step in and get involved, then we're ignoring the biggest contributor of this issue - EVERYBODY needs to be involved. .UserX: I think that growing more trees can reverse the adverse effects of manmade climate change. Trees release fresh oxygen. Protecting the environment is the key to reversing the harmful effects of climate change. It is most important to preserve the natural environment and plant more trees. Trees release oxygen which is very good for health.UserX: I think this is definitely important and will help but we need so much more than this. To me this is just one of the many important steps and changes we must make. All of these things and all of us working together can make a significant change.UserX: This is partially true, but fails to account for the fact that we couldn't possibly plant enough trees to absorb all of the CO2 produced. Not enough space on the Earth. And methane. 
.UserX: The CO2 level increases the most reason for climate change because the CO2 level increase it cause the air pollution.The pollution range increase is the problem of climate change.So I agree with you.
.UserX: I think that growing more trees can reverse the adverse effects of manmade climate change. Trees release fresh oxygen. Protecting the environment is the key to reversing the harmful effects of climate change. It is most important to preserve the natural environment and plant more trees. Trees release oxygen which is very good for health.UserX: I think that if we don't do something to start combatting climate change today, literally nothing will be there in the future to worry about - no economy left if there's no livable Earth left to inhabit. We're going to have to address this at some point, why not now? I'm not convinced that we can reverse what has already been done (ie, extinct species), but we can change the course of the future. .UserX: I think that generally speaking, climate change can be corrected for the future. But we need big corporations to be on board, and the federal government to start mandating it. .UserX: The statement is correct we need to talk about climate change for future because it is more helpful for the future generation. The federal government need to take the step about the climate change so it may be helpful for the upcoming generation.UserX: I don't believe that we can reverse the climate change that we have already done at this point, because we're too far gone. That said, I think that we do have the ability to at least slow it down or change the current course as to not do any more damage. 
.UserX: Some awareness is now spreading among the people. It should be expanded. Each and everyone must talk about this, everyone's responsibility in climate change. We all should stop avoiding plastics and co2 emissions. Every child must teach this in school. We need a kids should aware like Greta Thunberg.UserX: This is very true, but then isn't it time to start before it gets to be a worse situation? The economic impacts are starting to hit now.UserX: If we identify the negative feedback loops and break them, then we have a chance of slowing or even reversing climate change.UserX: Every year that passes we lose tools or opportiunities that could work to counteract climate change as well as more damage is added - therefore is -unfortunately- irrevrsible.UserX: This is the main problem that we are facing in the climate issue because some peoples are not considering the climate change problem. So the environment awareness is less. We need to consider the climate change.UserX: Obviously it is getting harder. Each year more damage is done and we cannot deny the inevitable.UserX: More should be focused on identifying the negative feedback and focusing on the positive aspects.UserX: Policy makers have vested interests with industry to ignore signals of overshoot and straining risks. Whatever action will be taken too late and there is no way to prevent feedback loops.UserX: I think it can be reversed, but it's going to take a collective effort from a lot of individuals to start this process.UserX: I think that growing more trees can reverse the adverse effects of manmade climate change. Trees release fresh oxygen. Protecting the environment is the key to reversing the harmful effects of climate change. It is most important to preserve the natural environment and plant more trees. Trees release oxygen which is very good for health.UserX: Everyone want to know about the climate change increase due to Manmade cause.So first we want start to reduce the waste level in our home.It leads to changes in the society if else we will face the huge climate changes in coming decades.
.UserX: More emphasis on the smaller, daily things we can do to reduce waste would probably allow us to see change more quickly than being shamed about every product we use that might potentially be bad for the environment. Manufacturers can be a big part of that. If there are no cheap, dangerous plastic shopping bags made, then they won't be part of our homes that we need to deal with. It's definitely a group effort.UserX: More effort is needed to raise the awareness in humans.If else the climate change cause the humans lives matter.Future decades will damaged by climate change.
.UserX: We need to talk more about the climate change because the future generation will affect due to the climate change. The atmosphere and oceans are already filled with CO2. They can’t take any longer . If they might , we might not be experiencing the rapid global climate change we experience daily. So we need to protect climate for our future generation.UserX: The climate change is the major important issue in current situation because the emission of CO2 content is more in the air so it will affect the ozone layer and this will become the major issue for the earth so we need to take care of our earth by controlling the climate change. We need to protect our earth for our future generation so we need to take a step based on the climate change.UserX: The climate change is the major issue in the current environment so we need to protect our environment by controlling the air pollution.
.UserX: There are technological, economic and political considerations that we must make if we are to reverse a trend that might otherwise threaten our very existence.UserX: adfadf.UserX: if we install proper home insulation the we could make a real change to some extent.UserX: CON TEST.UserX: PRO TEST.UserX: Refrigerants currently cause emissions throughout their life cycles, but 90 percent of emissions happen at disposal. .UserX: I don't feel that climate change is all man made, but we should be doing things to help the earth in general. .UserX: Sustainable efforts reduce and reverse the global warming trend.a Luca: Educating people (such as making it mandatory in the school system) on how to reverse climate change can give people the option to make positive changes to the situation.UserX: All we can do is reduce our impact but not reverse it.Unfortunately is statistically inevitable .Parisi Angelo: Prova test NG.Parisi Angelo: prova opposition.UserX: Billionaires who make money by killing planet earth, should be shot to death. They are not understanding what they are doing. Their aim is only money. .UserX: What point is there in preserving our climate for humanity, if, by taking these sorts of actions, we lose our collective humanity? Better for the human race to go extinct than to degrade to barbaric form of behavior advocated for in this argument.UserX: I feel that manmade climate change can be reversed by everyone working together and making sacrifices to improve the environment. It will be made possible by people figuring out ways to save on carbon emissions instead of taking the easiest route. If we can do that in more ways than one, we should be able to save the planet.UserX: Some damage towards the climate is currently irreversible to prevent reversal in time.UserX: By our actions many species have been made extinct and the chemistry of the gasses that make up our atmosphere have been altered.Climate change caused extinctions are permanent, it follows therefore we cannot wind back the clock.a Luca: Even though damage is done, there are ways to counter the damage through other actions. If enough of these are done, they can cumulatively overpower the irreversible actions and thus reduce climate change as a net overall.UserX: Technology may increase to where it can be - like developing time travel.UserX: .UserX: Billionaires who make money by killing planet earth, should be shot to death. They are not understanding what they are doing. Their aim is only money. .UserX: trjhsdhflkshlds.UserX: .UserX: .UserX: .UserX: argument 4.UserX: argument 4.Parisi Angelo: rply to ng.UserX: Maybe. But all humanity should collectively act together with the lead of the big super powers. If USA and China stay out, I am afraid it would be useless.UserX: Agree, the biggest contributors of CO2 emissions (USA and China) should do the most effort to reverse this.UserX: This should be part of every single citizen mendality in this planet. Assuming that this is a problem of someone else, then we will lose the fight before it even starts! .UserX: .UserX: I disagree even an agreemtn for other countries no matter how weak could be a good thing to do!.UserX: .UserX: .UserX: dfgdfgdgd.UserX: sdfdgdgdg.UserX: test opposing.UserX: example supporting.UserX: test _.UserX: I feel that manmade climate change can be reversed by everyone working together and making sacrifices to improve the environment. It will be made possible by people figuring out ways to save on carbon emissions instead of taking the easiest route. If we can do that in more ways than one, we should be able to save the planet.Parisi Angelo: prova test.Albertos: adfdfadf.Parisi Angelo: prova reply."""

US_PRESIDENTIAL_DEBATE = """00:00 CHRIS WALLACE
